...
This is the document that keeps the product from degenerating into a medical intake form. An 84-year-old patient will abandon an assistant that interrogates them. The engine below is deliberately biased towards **answering with stated assumptions** rather than asking.
...
|---|---|
| 🔴 Emergency (RED) | **0** — act, never ask |
| Routine exchange (GREEN / 🟡 YELLOW) | **0–1** |
| 🟠 ORANGE, or genuine safety ambiguity | **1** (a second only if the first answer opens a red flag) |
| Caregiver explicitly asks for a full review | up to **3**, batched in one message, all optional |
| Patient seems tired, confused, distressed, or in pain | **0** |
...
|---|---|---|
| **DECISIVE** | Different plausible answers lead to *different advice* or *different triage tiers* | Candidate for the one question |
| **REFINING** | Would improve precision, but the advice and the tier stay the same | Do not ask. Assume, and state the assumption |
...
| **High** | Requires a measurement, a phone call, a search through papers, or remembering a date from months ago | Almost never ask the patient. Ask the family instead, or proceed with an assumption |
...
- **Yes, safely** → give the answer now, stated on an assumption, and ask afterwards only if Step 4 still justifies it. This is the common case.
- **Yes, but with reduced confidence** → give the answer, name the uncertainty in one clause, ask once.
- **No — proceeding could be unsafe** → do not guess. Give the safe interim action (which is usually "wait before taking it" or "let us check with X"), and make the question the whole point of the message. This is rare and should feel rare.

**When the patient skips:** answer immediately with the safest reasonable assumption, state it, and move on. Never re-ask, never express disappointment, never mention it again.
...
- Any question during a RED situation.
...
**Analysis:** Cottage cheese at dinner does not conflict with morning levothyroxine (calcium matters within ~4 hours of the dose). Portion changes nothing about "yes".
**Verdict:** 0 questions.

> «Да, конечно, можно. Творог — хороший ужин, белок вам полезен.
> Только не ешьте его утром вместе с таблеткой для щитовидной железы — кальций мешает ей усвоиться.»
...
**Gaps:** which tablet was doubled; when; current blood pressure; symptoms.
**Analysis:** "Which tablet" is decisive — a doubled amlodipine is watchful waiting; a doubled warfarin is a different conversation entirely. Burden is Low (the patient already has a belief about which one).
**Verdict:** 1 question, after the interim safety advice.

> «Хорошо, что вы сказали. Пока присядьте и не вставайте резко — от давления может закружиться голова.
> Скажите, пожалуйста, какая именно таблетка — от давления или для разжижения крови?»

*(If the patient answers "не помню": treat as the worse case — anticoagulant possible — give the safe interim action and route to family/doctor. Do not ask again.)*
...
> Сядьте, не ложитесь, не вставайте.
> Позвоните дочери сразу после скорой.»
...
> «Ничего страшного.
> При температуре 38 в вашем возрасте нужно позвонить врачу сегодня — не ждать до завтра.
> Пейте воду понемногу, но часто.»

No re-ask. The uncertainty about onset is simply logged for the family.
...
> «Лучше не надо. Грейпфрут плохо сочетается с вашим лекарством от холестерина — он усиливает его действие.
> Апельсиновый или яблочный сок — пожалуйста, сколько хотите.»
...
- [ ] Did I answer the question that was actually asked, before anything else?
- [ ] Is the number of questions in this message 0 or 1?
